...
public class RayCastHitItem : MonoBehaviour
{
    ...
    public SOGunControlsYt sOGunControlsYt = null;
    ...
    public void RayCasting()
    {
        ...
        if (Physics.Raycast(ray, out RaycastHit hit, MaxDistance))
        {
            if (hit.collider.CompareTag("Item"))
            {
                ...
                if (hit.collider.GetComponentInChildren<SOGunControlsYt>() != null)
                {
                    sOGunControlsYt = hit.collider.gameObject.GetComponent<SOGunControlsYt>();
                    recoilControls.sOGunControls = sOGunControlsYt;
    ...
    public void WeaponSwitch()
    {
        if (inSlotController.weaponSlotFull == true)
        {
            ...
            sOGunControlsYt.Equipped = false;
            Drop();
        }
